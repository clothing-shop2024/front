...
export const termsOfUse = `
    ...
    ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 슬로우앤드 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
    ...
    ①회원 가입 혜택의 부여
    ②구매 고객에게 감사 쿠폰의 부여
    ③포인트 또는 쿠폰의 부여 및 발급, 유효기간 안내, 유효기간 만료 및 소멸
    ④등급별 지급되는 월별 쿠폰 등 혜택
    ⑤그 외 포인트 및 쿠폰의 부여, 사용, 만료, 소멸 등에 관한 사항

    제27조(플랫폼)
    1. '몰'외 타 플랫폼에서 판매하는 상품들은 플랫폼 정책상 '몰'과 판매가 기준이 다를 수 있습니다.

    제28조(구매제한)
    ① “몰”은 상습적인 반품/취소를 요청하는 구매자에게 구매 제한을 할 수 있습니다.
    1. 직전 세달간 구매 주문건에 60% 이상을 반품하는 경우.
    2. 반품 환불을 상습적으로 하는 경우

    위와 같은 내용은 일반적인 반품/취소가 아닌, 상습적으로 이루어지는 환불에 해당됩니다.
    몰에서는 높은 질의 서비스와 고객님들의 원활한 쇼핑을 제공하기 위해 위 내용에 해당되는 경우, 구매제한 조치가 이루어질 수 있습니다.
`
...
export const personalInformation = `
    ...
    “(주)쇼핑몰”는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다.

    “(주)쇼핑몰”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.



    - 수탁자 : ㈜컴퍼니(알림전송수탁업체 : ㈜수탁업체컴퍼니)
...
// 쇼핑정보 수신 동의
export const shoppingInformation = `
