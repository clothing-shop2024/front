...
import { PutMyInfoPasswordRequestDto } from 'src/apis/user/dto/request';
import InputBox from 'src/components/InputBox';
import { MAIN_ABSOLUTE_PATH, MY_PAGE_INFO_ABSOLUTE_PATH } from 'src/constant';
...
export default function PasswordModify() {
    ...
    const onPwUpdateButtonClickHandler = () => {
        ...
        const requestBody: PutMyInfoPasswordRequestDto = { password };
